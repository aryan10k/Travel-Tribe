...
const Tours = () => {
  const destinationJson = [
    { name: 'Baliya', img: Bali, time: '5 Days - 4 Nights', star: '3 (12 reviews)', price: '99999' },
    { name: 'Venice', img: Venice, time: '5 Days - 4 Nights', star: '3 (12 reviews)', price: '99999' },
    { name: 'Tokyo', img: Tokyo, time: '5 Days - 4 Nights', star: '3 (12 reviews)', price: '99999' },
    { name: 'India', img: India, time: '5 Days - 4 Nights', star: '3 (12 reviews)', price: '99999' },
    { name: 'Paris', img: Paris, time: '5 Days - 4 Nights', star: '3 (12 reviews)', price: '99999' },
    { name: 'Tokyo', img: Tokyo, time: '5 Days - 4 Nights', star: '3 (12 reviews)', price: '99999' },
  ]
  return (
    <>
                ...
                <div key={destination.name} className='overflow-hidden border shadow-lg shadow-gray-500 rounded-lg mb-5 md:mr-5'>
                  <div className=''>
                    ...
                    <div className='p-4'>
                      ...
                      <p className='flex gap-1 items-center'><Star width={20} fill='blue' />{destination.star}</p>
                      <p className='text-gray-600 mb-4 mt-2'>Experience the beauty and culture of {destination.name}</p>
                      <div className='flex gap-4'>
                        <button className='px-3 py-2 bg-blue-500 rounded-md text-white'>₹{destination.price}</button>
