               ...
               <div className='relative max-w-7xl mx-auto'>
                <div className='flex h-[650px] justify-center items-center lg:pt-0 pt-20'>
                    <div className='flex flex-col space-y-8 justify-center items-center text-center px-5 md:px-0'>
                        ...
                        <button className='bg-blue-500 px-3 py-2 text-white rounded-md font-semibold'>Start Exploring</button>
                    </div>
                </div>
               </div>
          </div>
            ...
            <div className='grid gap-5 grid-cols-4 flex-grow'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <select name="" id="" className='border border-gray-300 rounded-sm p-1'>
                        ...
                        <option value="">4 Guest 2 Children</option>
                        <option value="">6 Guest 4 Children</option>
                        <option value="">8 Guest 6 Children</option>
                        <option value="">10 Guest 8 Children</option>
                    </select>
                </div>
            </div>
            <div className='flex flex-col'>
                <label htmlFor="" className='text-white'>Transmissioin</label>
                <button className='bg-blue-500 transition-all ease-in text-white hover:bg-blue-600 hover:text-white px-5 h-8 py-1 rounded-md'>Book Now</button>
            </div>
