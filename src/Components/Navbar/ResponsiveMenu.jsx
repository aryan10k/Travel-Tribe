            ...
            <div>
                ...
                <nav className='mt-12'>
                    <ul className='space-y-4 text-xl text-black flex flex-col'>
                        ...
                        <Link to='#'><button onClick={()=>setShowMenu(false)} className='bg-blue-500 text-white px-4 py-1 rounded-md font-semibold'>Book Now</button></Link>
                    </ul>
                </nav>
            </div>
            <div>
                <h1>Made with ❤️ by Aryan</h1>
            </div>
        </div>
    )
}
